...
|-----------------|---------------------------------------------------------------------------------------------|------------|---------------|
| Full Snapshot   | [mainnet-geth-pbss-20260306](dist/mainnet-geth-pbss-20260306.csv)                           | **~5.4TB** | BSC >= v1.6.4 |
| Pruned Snapshot | [mainnet-geth-pbss-20260306-pruneancient](dist/mainnet-geth-pbss-20260306-pruneancient.csv) | **~1.5TB** | BSC >= v1.6.4 |
...
```bash
# full snapshot (~5.4TB, needs at least 6TB free, or 5TB with --auto-delete)
bash fetch-snapshot.sh -d -e -c --auto-delete -D /data/snapshot -E /data/bsc mainnet-geth-pbss-20260306

# pruned snapshot (~1.5TB, needs at least 2TB free with --auto-delete)
bash fetch-snapshot.sh -d -e -c -p --auto-delete -D /data/snapshot -E /data/bsc mainnet-geth-pbss-20260306
```
...
bash fetch-snapshot.sh -d -c -D /data/snapshot mainnet-geth-pbss-20260306

# step 2: extract to datadir
bash fetch-snapshot.sh -e -D /data/snapshot -E /data/bsc mainnet-geth-pbss-20260306
```
...
| ---- | ------- | ---- | ---- | ------------------ |
| Archive MDBX | BSC-MainNet | [20260302_mainnet_reth_mdbx_static_files_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_mdbx_static_files_archive_node.tar.zst) <br> [20260302_mainnet_reth_mdbx_db_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_mdbx_db_archive_node.tar.zst) | 2.76 TiB <br> 3.27 TiB | `--db.max-size=12TB` <br> `--db.page-size=8KB` |
| Archive MDBX | BSC-TestNet | [20260302_testnet_reth_mdbx_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_testnet_reth_mdbx_archive_node.tar.zst) | 441.22 GiB | - |
| Full MDBX | BSC-TestNet | [20260302_testnet_reth_mdbx_full_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_testnet_reth_mdbx_full_node.tar.zst) | 273.46 GiB | - |
| Full MDBX | BSC-MainNet | [20260302_mainnet_reth_mdbx_full_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_mdbx_full_node.tar.zst) | 3.73 TiB | - |
| Full TrieDB | BSC-TestNet | [20260302_testnet_reth_triedb_full_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_testnet_reth_triedb_full_node.tar.zst) | 456.04 GiB | - |
| Full TrieDB | BSC-MainNet | [20260302_mainnet_reth_triedb_full_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_triedb_full_node.tar.zst) | 3.64 TiB | - |
| Archive TrieDB | BSC-TestNet | [20260302_testnet_reth_triedb_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_testnet_reth_triedb_archive_node.tar.zst) | 519.73 GiB | - |
| Archive TrieDB | BSC-MainNet | [20260302_mainnet_reth_triedb_static_files_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_triedb_static_files_archive_node.tar.zst) <br> [20260302_mainnet_reth_triedb_db_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_triedb_db_archive_node.tar.zst) <br> [20260302_mainnet_reth_triedb_triedb_archive_node.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/20260302_mainnet_reth_triedb_triedb_archive_node.tar.zst) | 2.76 TiB <br> 3.12 TiB <br> 746.57 GiB | `--db.max-size=12TB` <br> `--db.page-size=8KB` |
