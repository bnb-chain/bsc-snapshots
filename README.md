...
|-----------------|---------------------------------------------------------------------------------------------|------------|---------------|
| Full Snapshot   | [mainnet-geth-pbss-20251205](dist/mainnet-geth-pbss-20251205.csv)                           | **~4.7TB** | BSC >= v1.6.4 |
| Pruned Snapshot | [mainnet-geth-pbss-20251205-pruneancient](dist/mainnet-geth-pbss-20251205-pruneancient.csv) | **~1.3TB** | BSC >= v1.6.4 |
